...
// Source: github.com/FreakyGranny/launchpad-api/internal/app/models (interfaces: UserImpl)
...
func (m *MockUserImpl) FindByID(arg0 int) (*models.User, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockUserImplMockRecorder) FindByID(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByID", reflect.TypeOf((*MockUserImpl)(nil).FindByID), arg0)
}
